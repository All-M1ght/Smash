...
l1_filter[1] = numpy.array([[1, 1, 1],
                            [0, 0, 0],
                            [-1, -1, -1]])
print(type(l1_filter))
print(l1_filter[0,2,1])
# print(img.shape)
# print(l1_filter[0])
# print(img[0:3, 0:6])
# print("进")
# print(img.shape[0] - l1_filter.shape[1] + 1)
...
io.imshow(skimage.color.rgb2gray(l1_feature_map_relu_pool[:,:,0]))
io.show()
io.imshow(skimage.color.rgb2gray(l1_feature_map_relu_pool[:,:,1]))
io.show()
# Second conv layer
